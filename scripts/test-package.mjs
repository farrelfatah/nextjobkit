...
try {
  ...
  const installedCli = path.join(installRoot, "node_modules/next-job-kit/bin/next-job-kit.mjs");
  const packedWorkspace = path.join(temporaryRoot, "packed-workspace");
  execFileSync(process.execPath, [installedCli, "init", packedWorkspace], { stdio: "pipe" });
